...
<div id="loginSuccess" class="login-success" aria-hidden="true"><div class="login-success-box"><div class="success-check"><i class="bi bi-check-lg"></i></div><h4>Berhasil</h4><p>Berhasil masuk. Mengalihkan...</p></div></div>
<main class="auth-shell">
    <section class="auth-showcase">
        <div class="showcase-circle circle-one"></div><div class="showcase-circle circle-two"></div>
        <div class="school-mark"><span><i class="bi bi-mortarboard-fill"></i></span><div><strong>Sistem Absensi Siswa</strong><small>Sekolah Harapan Bangsa</small></div></div>
