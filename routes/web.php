...
Route::middleware('auth')->group(function(){
 ...
 Route::middleware('role:admin')->group(function(){
  ...
  Route::post('/students/import',[StudentController::class,'import'])->name('students.import'); Route::get('/students/import/template',[StudentController::class,'importTemplate'])->name('students.import.template');
 ...
 Route::middleware('role:admin,wali_kelas')->group(function(){
  Route::get('/students',[StudentController::class,'index'])->name('students.index'); Route::get('/students/cards/all',[StudentCardController::class,'all'])->name('students.cards.all'); Route::get('/students/{student}',[StudentController::class,'show'])->whereNumber('student')->name('students.show'); Route::get('/students/{student}/card',[StudentCardController::class,'show'])->whereNumber('student')->name('students.card'); Route::get('/students/{student}/card/pdf',[StudentCardController::class,'pdf'])->whereNumber('student')->name('students.card.pdf');
